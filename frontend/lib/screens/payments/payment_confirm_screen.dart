  ...
  Future<void> _confirm() async {
    ...
    try {
      await _service.confirmPayment(widget.invoice.id, {
        ...
        if (_transactionCode.text.trim().isNotEmpty)
          'transactionCode': _transactionCode.text.trim(),
      ...
      body: ListView(
        ...
        children: [
          ...
          FilledButton.icon(
            ...
            label: Text(
              _saving ? 'Đang xác nhận...' : 'Xác nhận đã thanh toán',
            ),
          ),
        ],
      ),
